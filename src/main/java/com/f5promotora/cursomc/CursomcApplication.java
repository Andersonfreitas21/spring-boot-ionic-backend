...
import com.f5promotora.cursomc.domain.Estado;
import com.f5promotora.cursomc.domain.ItemPedido;
import com.f5promotora.cursomc.domain.Pagamento;
import com.f5promotora.cursomc.domain.PagamentoComBoleto;
import com.f5promotora.cursomc.domain.PagamentoComCartao;
import com.f5promotora.cursomc.domain.Pedido;
import com.f5promotora.cursomc.domain.Produto;
import com.f5promotora.cursomc.domain.enums.EstadoPagamento;
import com.f5promotora.cursomc.domain.enums.TipoCliente;
import com.f5promotora.cursomc.repositories.CategoriaRepository;
import com.f5promotora.cursomc.repositories.CidadeRepository;
import com.f5promotora.cursomc.repositories.ClienteRepository;
import com.f5promotora.cursomc.repositories.EnderecoRepository;
import com.f5promotora.cursomc.repositories.EstadoRepository;
import com.f5promotora.cursomc.repositories.ItemPedidoRepository;
...
import com.f5promotora.cursomc.repositories.ProdutoRepository;
...
//
//		cli1.getTelefones().addAll(Arrays.asList("34115645", "34561281"));
//
